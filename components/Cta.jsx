    ...
    return (
        <div className='shadow-2xl w-full items-center justify-center flex flex-col pb-2 h-auto sm:h-[250px] dark:bg-[#041120]'>
            <div className='container flex flex-col justify-center items-center'>
                <div>
                    <p className="text-2xl sm:text-4xl font-bold relative max-w-xl text-center bg-gradient-to-r from-blue-600 to-[#07D2FB] bg-clip-text text-transparent align-middle ">
