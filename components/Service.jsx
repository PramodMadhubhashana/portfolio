    ...
    return (
        <div className="flex flex-col container max-w-[1100px] pt-10">
            <div className="flex flex-col">
                ...
                <div className="flex-col pt-14 grid xl:grid-cols-2 justify-center gap-y-12 xl:gap-y-24 ">
                    {ServiceData.map((item, index) => {
                        return (
                            <Card key={index} className='w-full max-w-[424px] h-[300px] flex flex-col pt-16 pb-10 justify-center items-center relative hover:shadow-2xl hover:shadow-blue-600'>
